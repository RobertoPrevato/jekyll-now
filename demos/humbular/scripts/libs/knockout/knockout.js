    ...
    return {
        ...
        triggerEvent: function (element, eventType) {
            ...
            if (jQueryInstance && !useClickWorkaround) {
                jQueryInstance(element)['trigger'](eventType, [true, "knockout"]);//modified line. It's bad design from Knockout to trigger change event on elements that are not changed by user.
